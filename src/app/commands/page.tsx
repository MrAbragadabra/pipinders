...
export default function Commands() {
	...
	return (
		<section>
			<div>
				<h2 className="text-white uppercase text-4xl font-bold text-center">Команды</h2>
			</div>
			<div>
				<ul className="lg:px-20 px-10 list-disc text-white font-semibold mt-5 text-3xl">
					...
					<li className="mb-5 text-left leading-10">
						...
						- поможет вам сделать скин из своей развертки скин в png. Вам нужно предоставить прямую
						ссылку на png файл из интернета. Для этого можно использовать imgur или github
					</li>
					<li className="mb-5 text-left leading-10">
						<span
					...
					<li className="mb-5 text-left leading-10">
						...
						- авторизация при входе на сервер (это требуется для безопасности вашего аккаунта, чтобы
						никто не смог под вашим ником что-нибудь натворить)
					</li>
					<li className="mb-5 text-left leading-10">
						<span
					...
					<li className="mb-5 text-left leading-10">
						...
						- сообщит всем игрокам в чате о том, что вы больше не AFK (команду вызывать можно раз в
						10 секунд)
					</li>
				</ul>
			</div>
			{copied && (
				<div
					className={`fixed bottom-5 bg-lime-900 text-white py-2 px-4 rounded text-xl z-50 m-2 std-toast ${
