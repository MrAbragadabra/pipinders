		...
		<section>
			<div>
				...
				<p className='text-justify text-white font-semibold mt-5 text-3xl leading-10'>
					Для работы сервера приходится оплачивать хостинг (ничего себе). Если вы
					хотите помочь работе сервера, то можете оставлять донат в любое время (все деньги 100% идут только на оплату хостинга):
				</p>
				<iframe
